...
<!--- Update website talk to use nhsrpysoc-reusable slug-->
<!-- Use one of the undraw images for the website-->

:::: {.columns}
::: {.column}
![](img/undraw-conference.svg)
...
![](img/undraw-dreamer.svg)   

[Work on great open source code,]{.fragment .fade-in} [together,]{.fragment .fade-in} [publically,]{.fragment .fade-in} [across the system]{.fragment .fade-in}
...
.tg .tg-j1zr{background-color:#f9bd07;border-color:#f5f4f3;color:#f5f4f3;
